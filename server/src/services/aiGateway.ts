...
const defaultTemplates: PromptTemplate[] = [
  {
    ...
    systemPrompt: "Ты — контент-мейкер для психологического Instagram-канала «Берег.Микрошаги». Пиши на русском. Тон: спокойный, бережный, приземленный. Не используй агрессивную мотивацию. Формулировки должны снижать стыд и создавать ощущение доступного первого шага.",
    userPrompt: "Напиши caption для Instagram-карусели.\n\nТема: {title}\nЦель: {goal}\nХук: {hook}\nКлючевое сообщение: {keyMessage}\nCTA: {cta}\n\nФормат:\n- Первые 1-2 строки — цепляющий хук\n- Основной блок — полезный контент (3-7 пунктов)\n- Финал — мягкий CTA\n- Дисклеймер о самопомощи\n\nОбъём: 150-300 слов.",
  },
  {
    id: "caption-post",
    ...
    stage: "caption",
    contentType: "post",
    systemPrompt: "Ты — контент-мейкер для психологического Instagram-канала «Берег.Микрошаги». Пиши на русском. Тон: спокойный, бережный, приземленный.",
  ...
  },
  {
    ...
    stage: "caption",
    contentType: "reel",
    systemPrompt: "Ты — сценарист коротких Reels для психологического Instagram-канала «Берег.Микрошаги». Пиши на русском. Тон: эмпатичный, тёплый, без давления.",
    userPrompt: "Напиши сценарий для Reels (15-30 секунд).\n\nТема: {title}\nЦель: {goal}\nХук: {hook}\nКлючевое сообщение: {keyMessage}\n\nФормат:\n- Хук (первые 3 секунды)\n- Ситуация / узнаваемость\n- Один микрошаг\n- Финал с эмоцией\n\nОбъём: 80-150 слов (для озвучки).",
  },
  {
    id: "caption-stories",
    ...
    stage: "caption",
    contentType: "stories",
    systemPrompt: "Ты — контент-мейкер для Instagram Stories проекта «Берег.Микрошаги». Пиши на русском.",
  ...
  },
  {
    ...
    stage: "cta",
    contentType: "any",
    systemPrompt: "Ты — маркетолог, специалист по call-to-action для психологических аккаунтов. Пиши на русском.",
...
- Тёплая приглушённая палитра (землистые тона, оливковый, персиковый)
...
- Пример: #психология #микрошаги #бережноеразвитие`,
  },
  {
    id: "reel-script",
    name: "Сценарий Reels",
    stage: "reel",
    contentType: "reel",
    systemPrompt: "Ты — сценарист коротких Reels для психологического Instagram-канала. Пиши на русском. Тон: эмпатичный, без давления.",
